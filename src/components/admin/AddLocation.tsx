          ...
          <div className="border-4 border-gray-900 p-6 relative bg-gray-50 mt-8">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                 <div>
                     ...
                     <input type="text" required placeholder="e.g. Kotoka International Airport" className="w-full bg-white border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
                 </div>
                 <div>
                     <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Type</label>
                     <select required className="w-full bg-white border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors appearance-none">
                 ...
                 <div className="md:col-span-2">
                     ...
                     <input type="text" required placeholder="Street address" className="w-full bg-white border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
                 </div>
                 <div>
                     <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">City</label>
                     <input type="text" required placeholder="e.g. Accra" className="w-full bg-white border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
                 </div>
                 <div>
                     ...
                     {days.map(day => (
                         <div key={day} className="flex items-center justify-between text-sm">
                             ...
                             <div className="flex items-center space-x-2 flex-1 ml-4 border-l-2 pl-4 border-gray-100">
                                 <input type="time" defaultValue="08:00" className="bg-gray-50 border-2 border-gray-200 p-1 font-bold focus:border-red-600" />
                                 <span className="text-gray-400 font-bold">to</span>
                                 <input type="time" defaultValue="18:00" className="bg-gray-50 border-2 border-gray-200 p-1 font-bold focus:border-red-600" />
                             </div>
                  ...
                  <div className="border-2 border-gray-200 p-6">
                      ...
                      <div className="space-y-4">
                          <div>
                             ...
                             <input type="tel" required placeholder="+233 XX XXX XXXX" className="w-full bg-white border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
                          </div>
                      </div>
                  </div>
                  ...
                  <div className="border-2 border-gray-200 p-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                          <div>
                             ...
                             <input type="text" placeholder="e.g. 5.6037" className="w-full bg-white border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
                          </div>
                          <div>
                             <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Longitude</label>
                             <input type="text" placeholder="e.g. -0.1870" className="w-full bg-white border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
                          </div>
                      </div>
                  </div>
              </div>

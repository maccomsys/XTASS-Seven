          ...
          <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                 <div className="bg-gray-100 aspect-video relative group">
                    <img src="https://i.ibb.co/8g9MphYk/Airport-Pickup-7.jpg" alt="Car" className="w-full h-full object-cover" />
                 ...
                 <div className="bg-gray-100 aspect-video relative group">
                    <img src="https://i.ibb.co/HTVggwbD/Airport-Pickup-5.jpg" alt="Car Interior" className="w-full h-full object-cover" />
                    <button type="button" className="absolute top-2 right-2 bg-red-600 text-white p-1 text-xs opacity-0 group-hover:opacity-100 transition-opacity">Remove</button>
                 </div>
              </div>

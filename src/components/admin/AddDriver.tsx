    ...
    <AdminLayout>
      <div className="p-8 max-w-5xl mx-auto border-l-4 border-gray-900 border-r-4 border-r-gray-900 bg-white shadow-[8px_8px_0_0_rgba(0,0,0,1)]">
        <div className="flex justify-between items-center mb-8 border-b-4 border-gray-900 pb-4">
          <h1 className="text-3xl font-black text-gray-900 uppercase tracking-tight">Add New Driver</h1>
        ...
        <form onSubmit={handleSave} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div>
                 ...
                 <input type="text" required placeholder="e.g. John" className="w-full bg-gray-50 border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
             </div>
             <div>
                 <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Last Name</label>
                 <input type="text" required placeholder="e.g. Doe" className="w-full bg-gray-50 border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
             </div>
             <div>
                 <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Email Address</label>
                 <input type="email" required placeholder="john.doe@xtass.com" className="w-full bg-gray-50 border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
             </div>
             <div>
                 <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Phone Number</label>
                 <input type="tel" required placeholder="+233 24 123 4567" className="w-full bg-gray-50 border-2 border-gray-200 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
             </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 border-2 border-gray-200">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                     ...
                     <input type="text" required placeholder="DVLA-XXXX-YY" className="w-full bg-white border-2 border-gray-300 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors uppercase" />
                </div>
                <div>
                     <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">License Expiry</label>
                     <input type="date" required className="w-full bg-white border-2 border-gray-300 text-gray-900 text-sm font-bold p-3 focus:ring-0 focus:border-red-600 transition-colors" />
                </div>
             </div>
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <label className="flex items-center">
                    <input type="checkbox" required className="w-4 h-4 text-red-600 border-2 border-gray-300 focus:ring-red-500 mr-2" />
          ...
          <div className="border-2 border-dashed border-gray-300 p-8 text-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <p className="text-sm font-black text-gray-900 uppercase tracking-wider mb-1">Upload Profile Photo</p>
              <p className="text-xs text-gray-500 font-bold mb-4">Clear headshot required (Max 5MB)</p>
          ...
          <div className="flex items-center justify-between border-y-2 border-gray-200 py-6">
             <div>
                ...
                <p className="text-xs text-gray-500 font-bold mt-1">Set to active to allow the driver to receive trip assignments.</p>
             </div>
             <button 
                type="button"
